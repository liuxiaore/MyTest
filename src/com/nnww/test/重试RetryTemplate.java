...
public abstract class 重试RetryTemplate {
    ...
    public 重试RetryTemplate setSleepTime(int sleepTime) {
        if(sleepTime < 0) {
    ...
    public 重试RetryTemplate setRetryTime(int retryTime) {
        if (retryTime <= 0) {
    ...
    public Object submit(ExecutorService executorService) {
        ...
        return executorService.submit((Callable<? extends Object>) () -> execute());
    }
